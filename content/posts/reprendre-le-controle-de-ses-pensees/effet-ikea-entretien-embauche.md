---
title: "Effet IKEA lors d'un entretien d'embauche : mythes à déconstruire"
date: 2026-03-12T06:16:52+00:00
description: "Mei affronte l'effet IKEA lors d'un entretien d'embauche. Déconstruisons les idées reçues et apprenons 3 techniques concrètes pour reprendre le contrôle."
categories: ["Reprendre le contrôle de ses pensées"]
tags: ["effet IKEA", "entretien d'embauche", "biais cognitif", "confiance en soi", "techniques pratiques"]
slug: "effet-ikea-entretien-embauche"
readingTime: 6
wordCount: 1559
personnage: "Mei"
sujet: "effet IKEA"
contexte: "lors d'un entretien d'embauche"
draft: false
---
...
Pour Mei, l'effet IKEA agit comme un biais cognitif : elle valorise ses propres réalisations et son processus de création bien plus que ce qu'un employeur pourrait juger utile. Ce mécanisme possède des racines psychologiques profondes liées au besoin d'identité et à la justification de l'effort. Dan Ariely et ses collègues démontrent que l'effort produit un sentiment de propriété qui augmente la valeur perçue, indépendamment de la qualité objective du résultat final.
...
## Mei commence à relativiser

Après son premier entretien, Mei marche tranquillement dans la rue, son dossier sous le bras. Elle ressent un mélange de soulagement et de déception : ses explications techniques n'ont pas provoqué l'enthousiasme espéré. Installée dans un café, elle reprend ses notes et applique la technique de l'observateur extérieur. Elle rédige une fiche concise, supprime les termes trop mélioratifs et liste trois preuves concrètes de l'impact de son dernier projet.

Lors du rendez-vous suivant, elle prend une grande inspiration avant d'entrer et se remémore ses trois preuves. Quand le recruteur suggère une autre manière d'aborder un problème, Mei utilise la technique du feedback inversé en demandant d'abord l'avis de son interlocuteur. Le ton change radicalement : elle écoute, reformule, puis expose un résultat tangible en quelques mots. Son corps se détend. Elle comprend qu'elle est plus efficace de montrer l'utilité de son travail plutôt que la beauté de l'effort fourni.

Peu à peu, les entretiens ne sont plus des séances de défense de ses créations, mais de véritables espaces d'échange. Mei conserve son goût pour le travail bien fait, mais elle sait désormais le traduire en arguments convaincants. Elle voit maintenant ses réalisations comme des outils au service d'un objectif, et non plus comme une part indissociable de son identité.
