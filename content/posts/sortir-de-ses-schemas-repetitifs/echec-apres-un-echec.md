---
title: "Échec après un échec : comprendre ses causes profondes"
date: 2026-03-12T10:39:17+00:00
description: "Après un échec après un échec, Sophie explore les causes profondes et apprend 3 techniques concrètes pour arrêter de procrastiner et rebondir."
categories: ["Sortir de ses schémas répétitifs"]
tags: ["échec", "procrastination", "résilience", "psychologie", "auto-compassion"]
slug: "echec-apres-un-echec"
readingTime: 6
wordCount: 1611
personnage: "Sophie"
sujet: "échec"
...
L'échec est l'expérience subjective de ne pas atteindre un objectif attendu. On le ressent souvent comme une perte, une remise en question de soi ou une frustration profonde. Pour Sophie, l'échec prend la forme de refus répétés qui érodent sa confiance et déclenchent un réflexe de procrastination.
...
Exercice pratique :
1. Prenez une feuille et décrivez l'échec de manière factuelle, sans jugement.
2. Répondez à quatre questions pour chaque point :
...
3. Reformulez votre pensée en privilégiant les éléments sur lesquels vous avez du pouvoir. Par exemple, transformez "Je suis nulle" en "Ma candidature n'était pas assez ciblée, je peux ajuster ma lettre".
...
Exercice pratique :
1. Décomposez votre objectif en micro-tâches de 5 à 20 minutes (par exemple : 1. ouvrir le fichier, 2. écrire le premier paragraphe, 3. relire pendant 10 minutes).
2. Formulez une intention de type "Si... alors..." : "S'il est 10h, alors j'ouvre mon modèle de lettre et je travaille sur le titre pendant 15 minutes."
3. Utilisez un minuteur et respectez scrupuleusement cette règle simple.
...
Exercice pratique :
1. Planifiez de petits tests à faible enjeu (par exemple : envoyer une candidature imparfaite à une offre secondaire, demander un avis informel à un ancien collègue).
2. Avant chaque test, fixez une intention d'apprentissage : "Je veux voir comment on réagit à ce format de CV, je noterai les retours sans me juger."
3. Après le test, notez trois faits concrets et une chose à essayer différemment. Terminez par une phrase bienveillante, comme : "C'était courageux d'essayer, j'apprends au fur et à mesure."
