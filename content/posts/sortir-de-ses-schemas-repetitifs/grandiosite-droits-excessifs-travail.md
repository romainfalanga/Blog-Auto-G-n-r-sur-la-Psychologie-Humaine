---
title: "Droits personnels excessifs/grandiosité au travail : signes chez HPI"
date: 2026-03-14T10:27:08+00:00
description: "Découvrez comment reconnaître les droits personnels excessifs et la grandiosité au travail, avec 3 techniques pratiques pour les gérer."
categories: ["Sortir de ses schémas répétitifs"]
tags: ["grandiosité", "droits-personnels", "narcissisme-professionnel", "HPI", "gestion-des-emotions"]
...
La grandiosité, ou l'attitude de droits personnels excessifs, est la tendance à se considérer comme exceptionnel, à attendre des privilèges et à minimiser la légitimité des autres. Le concept renvoie aux travaux sur le narcissisme, étudiés notamment par Heinz Kohut et Otto Kernberg, qui ont montré que la grandiosité se construit en partie comme une défense contre une vulnérabilité intérieure.

Pour le dire simplement : les droits personnels excessifs et la grandiosité désignent une conviction persistante d'avoir des droits particuliers et d'être supérieur aux autres, entraînant des revendications de traitement privilégié et une difficulté à reconnaître les limites. Dans le champ scientifique, la grandiosité apparaît comme un trait central du narcissisme, étudié par la psychanalyse classique (Kohut, Kernberg) et par la psychologie contemporaine (DSM-5, recherches sur les traits narcissiques). Chez les personnes à haut potentiel, la confiance intellectuelle peut basculer, pour certains, en sentiment de supériorité, surtout si l'environnement renforce l'idée qu'elles "valent" plus que la moyenne.

Des études en psychologie sociale montrent que la grandiosité se manifeste plus fréquemment dans des contextes compétitifs ou hiérarchiques, où la reconnaissance sociale est très liée au statut professionnel. Ces comportements ne constituent pas un diagnostic à poser soi-même, mais des indices pour comprendre comment on interagit avec les autres, et décider d'agir autrement si ces schémas deviennent pesants.
...
Cette posture freine la montée en compétence de l'équipe et détériore les relations de confiance nécessaires à un climat de travail sain.

## 3 techniques pour mieux gérer ces tendances

### 1. L'auto-questionnement factuel
Technique : revenir aux faits, mesurer, documenter.
Exercice concret : avant de réagir à une situation qui déclenche le sentiment d'être lésé ou supérieur, prenez une minute pour remplir cette checklist dans un carnet ou sur votre téléphone :
1) Quel est l'événement factuel, sans interprétation ? (Exemple : "Anna propose une alternative à la diapositive 3.")
2) Quelle preuve ai-je que je suis la seule personne à avoir raison ? (Listez les preuves concrètes.)
...
Exercice concret : définissez un "pari d'humilité" sur deux semaines. Choisissez une situation fréquente (réunion hebdomadaire, revue de projet, distribution des tâches) et engagez-vous à :
* Laisser parler sans interruption pendant 5 minutes.
* Poser au moins trois questions ouvertes aux autres participants.
* Accepter une modification sur votre proposition sans argumenter plus de 30 secondes.
* Noter ensuite vos émotions et les réactions observées pendant 48 heures.
But : l'objectif est de constater que renoncer au contrôle ne mène pas systématiquement à la catastrophe, et débouche souvent sur des échanges plus riches. Ces expériences permettent de recalibrer ses attentes face à la réalité du groupe.

### 3. La pratique de la reconnaissance réciproque et du feedback structuré
Technique : remplacer la revendication de droits par une stratégie de reconnaissance mutuelle.
Exercice concret : mettez en place, pendant un mois, un rituel hebdomadaire simple avec un collègue de confiance. Prenez 10 minutes pour donner et recevoir un feedback structuré, en respectant ces règles :
* Chaque retour commence par une observation factuelle.
* Formulez ensuite l'impact ("Quand tu as fait cela, cela a permis ou dérangé ceci").
* Terminez par une demande précise pour l'avenir.
...
Si ces schémas vous semblent profondément ancrés ou s'ils provoquent une souffrance importante dans votre travail ou vos relations, vous pouvez vous tourner vers un psychologue ou un thérapeute. Parler avec un professionnel peut aider à comprendre l'origine de ces attentes et à construire un travail durable sur soi, en douceur et en sécurité.